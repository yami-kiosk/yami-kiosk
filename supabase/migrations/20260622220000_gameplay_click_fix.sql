-- Raise server slack for combo/skills headroom; leaderboard-only anti-cheat.
-- Local gameplay uncapped on client — sync only trims seasonYenEarned for rank.
...
declare
  ...
  v_sync_slack constant numeric := 2.0;
